...
<form method="post">
	<fieldset>
		...
		Falcão jogou qual esporte?
		<br>
		<br>
		Não jogou nenhum esporte<input type="radio" name="p1" value="0"><br>
		Futebol<input type="radio" name="p1" value="0"><br>
		Futsal<input type="radio" name="p1" value="1"><br>
