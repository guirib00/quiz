...
<form method="post">
	<fieldset>
		...
		Qual continente é jogada a competição UEFA Champions League
		<br>
		<br>
		Europa<input type="radio" name="p1" value="1"><br>
		America<input type="radio" name="p1" value="0"><br>
		Africa<input type="radio" name="p1" value="0"><br>
